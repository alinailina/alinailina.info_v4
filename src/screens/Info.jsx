          ...
          <div>
            ...
            <ul>
              <li>
                <h4>Simplicity</h4>
                <p>
                  Clean code, <span>functional interfaces</span>. I believe
                  noise inhibits utility, and seek to remove everything that
                  doesn’t add value.{" "}
                </p>
              </li>
              <li>
                ...
                <p>
                  ...
                  <span>honest communication, trust, transparency</span> and
              ...
              <li>
                ...
                <p>
                  ...
                  <span>highly polished design</span>, with a touch of
                  awe(some).
                </p>
              </li>
              <li>
            ...
            <div>
              ...
              <p ref={contentRef} className={active ? "active" : " "}>
                Like mess. Wash whites with colours. Mind the gap. Take sugar
                with coffee. Go chasing waterfalls. Want to buy a plastic bag.
                Understand how or why pork gets pulled. Enjoy speed driving.
                Always say the right thing at the right time. Want fries with
                that. Stretch before exercising. Smoke. Stretch after
                exercising. Dance often enough. Stop believing. Settle.
              </p>
            </div>
            <h3>My happy place</h3>
            <p>
              I would fit very comfortably in a{" "}
              <span> cross-functional team</span> of developers, product
              managers, and designers delivering ethically-minded end-to-end
              software solutions.
            </p>
          </div>
        </div>
